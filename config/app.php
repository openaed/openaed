...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The ID of the area to use for OpenStreetMap queries.
    | Default is the Netherlands (3600047796).
    |
    */
    'region' => env('OSM_REGION', 3600047796),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The locales that are available in the application.
    |
    */
